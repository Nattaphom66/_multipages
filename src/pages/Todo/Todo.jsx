    ...
    <div className="todo-container">
      ...
      <div className="todo-filters-container">
        <div className="form-check form-switch d-flex align-items-center">
          ...
          />
          <label className="form-check-label d-flex align-items-center" htmlFor="flexSwitchCheckChecked">
            Show only&nbsp;
      ...
      {/* table */}
      <table className="table table table-striped;" style={{ boxShadow: "0 0 0.25rem gray", border: "1px solid lightgray" }}>
